...
--              hops = 0 means the module drops it directly as a finished item.
...
config.asteroidOutputs = {
  ["Adamantium"] = {   -- adamantiumAsteroid, drones 3..6, module tier 1
    ...
    main = {
      { item = "Adamantium Dust",                           hops = 1, via = "macerator"                  },
      { item = "Antimony Dust",                             hops = 3, via = "simple_washer"              },
      { item = "Bismuth Dust",                              hops = 1, via = "macerator"                  },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Fiery Steel Dust",                          hops = 3, via = "chemical_bath"              },
      { item = "Gallium Dust",                              hops = 1, via = "macerator"                  },
      { item = "Iron Dust",                                 hops = 2, via = "thermal_centrifuge"         },
      { item = "Lithium Dust",                              hops = 1, via = "macerator"                  },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
      { item = "Zinc Dust",                                 hops = 1, via = "macerator"                  },
    },
    processed = {
      { item = "Biotite Dust",                              hops = 3, via = "centrifuge"                 },
      { item = "Marble Dust",                               hops = 3, via = "centrifuge"                 },
      { item = "Metal Mixture Dust",                        hops = 3, via = "centrifuge"                 },
      { item = "Platinum Metallic Powder Dust",             hops = 2, via = "centrifuge"                 },
      { item = "Potassium Feldspar Dust",                   hops = 3, via = "centrifuge"                 },
      { item = "Quartzite Dust",                            hops = 3, via = "centrifuge"                 },
      { item = "Sand",                                      hops = 2, via = "centrifuge"                 },
      { item = "Silicon Dioxide Dust",                      hops = 3, via = "electrolyzer"               },
      { item = "Sodalite Dust",                             hops = 3, via = "centrifuge"                 },
      { item = "Tungstate Dust",                            hops = 2, via = "centrifuge"                 },
    },
  },
  ["Aluminium"] = {   -- aluminiumAsteroid, drones 1..3, module tier 1
    ...
    main = {
      { item = "Bauxite Dust",                              hops = 1, via = "macerator"                  },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Fiery Steel Dust",                          hops = 3, via = "chemical_bath"              },
      { item = "Gallium Dust",                              hops = 3, via = "macerator"                  },
      { item = "Grossular Dust",                            hops = 1, via = "macerator"                  },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Rutile Dust",                               hops = 1, via = "macerator"                  },
      { item = "Small Pile of Rutile Dust",                 hops = 3, via = "electromagnetic_separator"  },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
      { item = "Zirconium Nugget",                          hops = 3, via = "electromagnetic_separator"  },
    },
    processed = {
      { item = "Alumina Dust",                              hops = 2, via = "centrifuge"                 },
      { item = "Aluminium Dust",                            hops = 2, via = "electrolyzer"               },
      { item = "Biotite Dust",                              hops = 3, via = "centrifuge"                 },
      { item = "Calcite Dust",                              hops = 2, via = "centrifuge"                 },
      { item = "Calcium Dust",                              hops = 2, via = "electrolyzer"               },
      { item = "Carbon Dust",                               hops = 3, via = "electrolyzer"               },
      { item = "Gold Dust",                                 hops = 2, via = "centrifuge"                 },
      { item = "Iron Dust",                                 hops = 2, via = "centrifuge"                 },
      { item = "Marble Dust",                               hops = 3, via = "centrifuge"                 },
      { item = "Metal Mixture Dust",                        hops = 3, via = "centrifuge"                 },
      { item = "Oxygen Cell",                               hops = 2, via = "electrolyzer"               },
      { item = "Platinum Metallic Powder Dust",             hops = 2, via = "centrifuge"                 },
      { item = "Potassium Feldspar Dust",                   hops = 3, via = "centrifuge"                 },
      { item = "Quartzite Dust",                            hops = 3, via = "centrifuge"                 },
      { item = "Quicklime Dust",                            hops = 2, via = "centrifuge"                 },
      { item = "Sand",                                      hops = 2, via = "centrifuge"                 },
      { item = "Silicon Dioxide Dust",                      hops = 2, via = "electrolyzer"               },
      { item = "Sodalite Dust",                             hops = 3, via = "centrifuge"                 },
      { item = "Tungstate Dust",                            hops = 2, via = "centrifuge"                 },
      { item = "Vanadium Dust",                             hops = 2, via = "centrifuge"                 },
    },
  },
  ["Aluminium-LanthLine"] = {   -- aluminiumLanthlineAsteroid, drones 1..6, module tier 1
    ...
    main = {
      { item = "Bastnasite Dust",                           hops = 3, via = "simple_washer"              },
      { item = "Bauxite Dust",                              hops = 1, via = "macerator"                  },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Fiery Steel Dust",                          hops = 3, via = "chemical_bath"              },
      { item = "Gallium Dust",                              hops = 3, via = "macerator"                  },
      { item = "Grossular Dust",                            hops = 1, via = "macerator"                  },
      { item = "Monazite",                                  hops = 3, via = "sifter"                     },
      { item = "Monazite Dust",                             hops = 3, via = "simple_washer"              },
      { item = "Neodymium Dust",                            hops = 1, via = "macerator"                  },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Rare Earth",                                hops = 2, via = "thermal_centrifuge"         },
      { item = "Rutile Dust",                               hops = 2, via = "thermal_centrifuge"         },
      { item = "Small Pile of Rutile Dust",                 hops = 3, via = "electromagnetic_separator"  },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
      { item = "Thorium Dust",                              hops = 1, via = "macerator"                  },
      { item = "Zirconium Nugget",                          hops = 3, via = "electromagnetic_separator"  },
    },
    processed = {
      { item = "Alumina Dust",                              hops = 2, via = "centrifuge"                 },
      ...
      { item = "Silicon Dioxide Dust",                      hops = 2, via = "electrolyzer"               },
      { item = "Sodalite Dust",                             hops = 3, via = "centrifuge"                 },
      { item = "Thorium 232 Dust",                          hops = 2, via = "centrifuge"                 },
      { item = "Tungstate Dust",                            hops = 2, via = "centrifuge"                 },
      { item = "Vanadium Dust",                             hops = 2, via = "centrifuge"                 },
    },
  },
  ["Ardite/Cobalt"] = {   -- arditeCobaltAsteroid, drones 3..8, module tier 1
    ...
    main = {
      { item = "Ardite Dust",                               hops = 1, via = "macerator"                  },
      { item = "Cobalt Dust",                               hops = 2, via = "chemical_bath"              },
      { item = "Cobaltite Dust",                            hops = 1, via = "macerator"                  },
      { item = "Manyullyn Dust",                            hops = 1, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 1, via = "macerator"                  },
    },
    processed = {
      { item = "Alumina Dust",                              hops = 3, via = "electrolyzer"               },
      { item = "Aluminium Dust",                            hops = 3, via = "electrolyzer"               },
      { item = "Arsenic Dust",                              hops = 2, via = "electrolyzer"               },
      { item = "Banded Iron Dust",                          hops = 3, via = "centrifuge"                 },
      { item = "Barite Dust",                               hops = 3, via = "centrifuge"                 },
      { item = "Bauxite Dust",                              hops = 3, via = "centrifuge"                 },
      { item = "Biotite Dust",                              hops = 2, via = "centrifuge"                 },
      { item = "Calcite Dust",                              hops = 3, via = "centrifuge"                 },
      { item = "Chromite Dust",                             hops = 3, via = "centrifuge"                 },
      { item = "Ilmenite Dust",                             hops = 3, via = "centrifuge"                 },
      { item = "Magnesium Dust",                            hops = 3, via = "centrifuge"                 },
      { item = "Marble Dust",                               hops = 2, via = "centrifuge"                 },
      { item = "Metal Mixture Dust",                        hops = 2, via = "centrifuge"                 },
      { item = "Oxygen Cell",                               hops = 3, via = "electrolyzer"               },
      { item = "Potassium Dust",                            hops = 3, via = "electrolyzer"               },
      { item = "Potassium Feldspar Dust",                   hops = 2, via = "centrifuge"                 },
      { item = "Pyrolusite Dust",                           hops = 3, via = "centrifuge"                 },
      { item = "Quartzite Dust",                            hops = 2, via = "centrifuge"                 },
      { item = "Raw Silicon Dust",                          hops = 3, via = "electrolyzer"               },
      { item = "Silicon Dioxide Dust",                      hops = 3, via = "electrolyzer"               },
      { item = "Sodalite Dust",                             hops = 2, via = "centrifuge"                 },
      { item = "Sodium Dust",                               hops = 3, via = "electrolyzer"               },
      { item = "Sulfur Dust",                               hops = 2, via = "electrolyzer"               },
    },
  },
  ["Basic Magic"] = {   -- basicMagicAsteroid, drones 2..5, module tier 1
    ...
    main = {
      { item = "Aer Crystal Powder",                        hops = 2, via = "macerator"                  },
      { item = "Air Shard",                                 hops = 1, via = "macerator"                  },
      { item = "Aqua Crystal Powder",                       hops = 2, via = "macerator"                  },
      { item = "Earth Shard",                               hops = 1, via = "macerator"                  },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Entropy Shard",                             hops = 1, via = "macerator"                  },
      { item = "Fire Shard",                                hops = 1, via = "macerator"                  },
      { item = "Gold Dust",                                 hops = 1, via = "macerator"                  },
      { item = "Ignis Crystal Powder",                      hops = 2, via = "macerator"                  },
      { item = "Infused Gold Dust",                         hops = 3, via = "simple_washer"              },
      { item = "Order Shard",                               hops = 1, via = "macerator"                  },
      { item = "Ordo Crystal Powder",                       hops = 2, via = "macerator"                  },
      { item = "Perditio Crystal Powder",                   hops = 2, via = "macerator"                  },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Shadow Metal Dust",                         hops = 1, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
      { item = "Terra Crystal Powder",                      hops = 2, via = "macerator"                  },
      { item = "Water Shard",                               hops = 1, via = "macerator"                  },
    },
    processed = {
      { item = "Biotite Dust",                              hops = 3, via = "centrifuge"                 },
      { item = "Marble Dust",                               hops = 3, via = "centrifuge"                 },
  ...
  ["Blue"] = {   -- blueAsteroid, drones 2..7, module tier 1
    ...
    main = {
      { item = "Andradite Dust",                            hops = 1, via = "macerator"                  },
      { item = "Calcite Dust",                              hops = 3, via = "simple_washer"              },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Fiery Steel Dust",                          hops = 3, via = "chemical_bath"              },
      { item = "Lapis Dust",                                hops = 2, via = "thermal_centrifuge"         },
      { item = "Lapis Lazuli",                              hops = 3, via = "sifter"                     },
      { item = "Lazurite",                                  hops = 1, via = "macerator"                  },
      { item = "Lazurite Dust",                             hops = 2, via = "macerator"                  },
      { item = "Malachite Dust",                            hops = 2, via = "thermal_centrifuge"         },
      { item = "Pyrite Dust",                               hops = 3, via = "macerator"                  },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Sodalite",                                  hops = 1, via = "macerator"                  },
      { item = "Sodalite Dust",                             hops = 2, via = "thermal_centrifuge"         },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
    },
    processed = {
      { item = "Alumina Dust",                              hops = 2, via = "centrifuge"                 },
      ...
      { item = "Calcium Dust",                              hops = 2, via = "electrolyzer"               },
      { item = "Carbon Dust",                               hops = 3, via = "electrolyzer"               },
      { item = "Copper Dust",                               hops = 3, via = "electrolyzer"               },
      { item = "Gold Dust",                                 hops = 2, via = "centrifuge"                 },
      { item = "Iron Dust",                                 hops = 2, via = "centrifuge"                 },
      { item = "Marble Dust",                               hops = 3, via = "centrifuge"                 },
      { item = "Metal Mixture Dust",                        hops = 3, via = "centrifuge"                 },
      ...
      { item = "Quartzite Dust",                            hops = 3, via = "centrifuge"                 },
      { item = "Quicklime Dust",                            hops = 2, via = "centrifuge"                 },
      { item = "Raw Silicon Dust",                          hops = 2, via = "electrolyzer"               },
      { item = "Rutile Dust",                               hops = 2, via = "centrifuge"                 },
      { item = "Sand",                                      hops = 2, via = "centrifuge"                 },
      { item = "Silicon Dioxide Dust",                      hops = 3, via = "electrolyzer"               },
      { item = "Sodium Dust",                               hops = 3, via = "electrolyzer"               },
      { item = "Tungstate Dust",                            hops = 2, via = "centrifuge"                 },
  ...
  ["Cheese"] = {   -- cheeseAsteroid, drones 4..12, module tier 2
    ...
    main = {
      { item = "Cheese Powder",                             hops = 1, via = "macerator"                  },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
    },
  ...
  ["Chrome"] = {   -- chromeAsteroid, drones 1..5, module tier 1
    ...
    main = {
      { item = "Chipped Ruby",                              hops = 3, via = "sifter"                     },
      { item = "Chrome Dust",                               hops = 1, via = "macerator"                  },
      { item = "Chromite Dust",                             hops = 3, via = "simple_washer"              },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Exquisite Ruby",                            hops = 3, via = "sifter"                     },
      { item = "Fiery Steel Dust",                          hops = 2, via = "chemical_bath"              },
      { item = "Flawed Ruby",                               hops = 3, via = "sifter"                     },
      { item = "Flawless Ruby",                             hops = 3, via = "sifter"                     },
      { item = "Iron Dust",                                 hops = 1, via = "macerator"                  },
      { item = "Magnesium Dust",                            hops = 2, via = "thermal_centrifuge"         },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Red Garnet Dust",                           hops = 2, via = "thermal_centrifuge"         },
      { item = "Ruby",                                      hops = 3, via = "sifter"                     },
      { item = "Ruby Dust",                                 hops = 3, via = "simple_washer"              },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
    },
    processed = {
      { item = "Almandine Dust",                            hops = 3, via = "centrifuge"                 },
      { item = "Biotite Dust",                              hops = 3, via = "centrifuge"                 },
      { item = "Marble Dust",                               hops = 3, via = "centrifuge"                 },
      { item = "Metal Mixture Dust",                        hops = 3, via = "centrifuge"                 },
      { item = "Platinum Metallic Powder Dust",             hops = 2, via = "centrifuge"                 },
      { item = "Potassium Feldspar Dust",                   hops = 3, via = "centrifuge"                 },
      { item = "Pyrope Dust",                               hops = 3, via = "centrifuge"                 },
      { item = "Quartzite Dust",                            hops = 3, via = "centrifuge"                 },
      { item = "Sand",                                      hops = 2, via = "centrifuge"                 },
      { item = "Silicon Dioxide Dust",                      hops = 3, via = "electrolyzer"               },
      { item = "Sodalite Dust",                             hops = 3, via = "centrifuge"                 },
      { item = "Spessartine Dust",                          hops = 3, via = "centrifuge"                 },
      { item = "Tungstate Dust",                            hops = 2, via = "centrifuge"                 },
    },
  },
  ["Clay"] = {   -- clayAsteroid, drones 0..5, module tier 1
    ...
    main = {
      { item = "Clay Dust",                                 hops = 1, via = "macerator"                  },
      { item = "Silicon Dioxide Dust",                      hops = 2, via = "thermal_centrifuge"         },
      { item = "Sodium Hydroxide Dust",                     hops = 3, via = "chemical_bath"              },
    },
    processed = {
      { item = "Alumina Dust",                              hops = 2, via = "electrolyzer"               },
      { item = "Aluminium Dust",                            hops = 3, via = "electrolyzer"               },
      { item = "Lithium Dust",                              hops = 2, via = "electrolyzer"               },
      { item = "Sodium Dust",                               hops = 2, via = "electrolyzer"               },
    },
  },
  ["Coal"] = {   -- coalAsteroid, drones 0..6, module tier 1
    ...
    main = {
      { item = "Carbon Dust",                               hops = 1, via = "macerator"                  },
      { item = "Coal",                                      hops = 1, via = "macerator"                  },
      { item = "Coal Dust",                                 hops = 2, via = "macerator"                  },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Graphite Dust",                             hops = 3, via = "simple_washer"              },
      { item = "Hydrated Coal Dust",                        hops = 3, via = "chemical_bath"              },
      { item = "Lignite Coal",                              hops = 1, via = "macerator"                  },
      { item = "Lignite Coal Dust",                         hops = 2, via = "macerator"                  },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
      { item = "Thorium Dust",                              hops = 2, via = "thermal_centrifuge"         },
    },
    processed = {
      { item = "Biotite Dust",                              hops = 3, via = "centrifuge"                 },
      { item = "Marble Dust",                               hops = 3, via = "centrifuge"                 },
      ...
      { item = "Silicon Dioxide Dust",                      hops = 3, via = "electrolyzer"               },
      { item = "Sodalite Dust",                             hops = 3, via = "centrifuge"                 },
      { item = "Thorium 232 Dust",                          hops = 3, via = "centrifuge"                 },
      { item = "Tungstate Dust",                            hops = 2, via = "centrifuge"                 },
    },
  },
  ["Copper"] = {   -- copperAsteroid, drones 0..5, module tier 1
    ...
    main = {
      { item = "Brown Limonite Dust",                       hops = 2, via = "thermal_centrifuge"         },
      { item = "Cadmium Dust",                              hops = 3, via = "macerator"                  },
      { item = "Calcite Dust",                              hops = 3, via = "macerator"                  },
      { item = "Chalcopyrite Dust",                         hops = 3, via = "simple_washer"              },
      { item = "Cobalt Dust",                               hops = 1, via = "macerator"                  },
      { item = "Copper Dust",                               hops = 1, via = "macerator"                  },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Fiery Steel Dust",                          hops = 3, via = "chemical_bath"              },
      { item = "Gold Dust",                                 hops = 2, via = "thermal_centrifuge"         },
      { item = "Malachite",                                 hops = 3, via = "sifter"                     },
      { item = "Malachite Dust",                            hops = 3, via = "simple_washer"              },
      { item = "Nickel Dust",                               hops = 3, via = "macerator"                  },
      { item = "Pyrite Dust",                               hops = 1, via = "macerator"                  },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
    },
    processed = {
      { item = "Biotite Dust",                              hops = 3, via = "centrifuge"                 },
      { item = "Iron Dust",                                 hops = 2, via = "electrolyzer"               },
      { item = "Marble Dust",                               hops = 3, via = "centrifuge"                 },
      { item = "Metal Mixture Dust",                        hops = 3, via = "centrifuge"                 },
      { item = "Oxygen Cell",                               hops = 3, via = "centrifuge"                 },
      { item = "Platinum Metallic Powder Dust",             hops = 2, via = "centrifuge"                 },
      { item = "Potassium Feldspar Dust",                   hops = 3, via = "centrifuge"                 },
      { item = "Quartzite Dust",                            hops = 3, via = "centrifuge"                 },
      { item = "Sand",                                      hops = 2, via = "centrifuge"                 },
  ...
  ["Cosmic"] = {   -- cosmicAsteroid, drones 6..12, module tier 2
    ...
    main = {
      { item = "Bedrockium Dust",                           hops = 1, via = "macerator"                  },
      { item = "Black Plutonium Dust",                      hops = 1, via = "macerator"                  },
      { item = "Cosmic Neutronium Dust",                    hops = 1, via = "macerator"                  },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Neutronium Dust",                           hops = 1, via = "macerator"                  },
      { item = "Neutronium Nanoparticles",                  hops = 2, via = "macerator"                  },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
    },
    processed = {
      ...
      { item = "Marble Dust",                               hops = 3, via = "centrifuge"                 },
      { item = "Metal Mixture Dust",                        hops = 3, via = "centrifuge"                 },
      { item = "Pile of Cosmic Neutrons",                   hops = 2, via = "centrifuge"                 },
      { item = "Platinum Metallic Powder Dust",             hops = 2, via = "centrifuge"                 },
      { item = "Potassium Feldspar Dust",                   hops = 3, via = "centrifuge"                 },
      { item = "Quartzite Dust",                            hops = 3, via = "centrifuge"                 },
      { item = "Sand",                                      hops = 2, via = "centrifuge"                 },
  ...
  ["Draconic"] = {   -- draconicAsteroid, drones 5..8, module tier 2
    ...
    main = {
      { item = "Awakened Draconium Dust",                   hops = 1, via = "macerator"                  },
      { item = "Draconium Dust",                            hops = 1, via = "macerator"                  },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Fluxed Electrum Dust",                      hops = 1, via = "macerator"                  },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
    },
    processed = {
  ...
  ["Draconic Core"] = {   -- draconicCoreRuin, drones 8..10, module tier 3
    ...
    main = {
      { item = "Draconic Core",                             hops = 0, via = "dropped directly"           },
      { item = "Draconic Core Schematic",                   hops = 0, via = "dropped directly"           },
      { item = "Zero Point Module",                         hops = 0, via = "dropped directly"           },
    },
    processed = {
    },
  },
  ["Europium"] = {   -- europiumAsteroid, drones 6..12, module tier 2
    ...
    main = {
      { item = "Borax Dust",                                hops = 1, via = "macerator"                  },
      { item = "Callisto Ice Dust",                         hops = 1, via = "macerator"                  },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Europium Dust",                             hops = 1, via = "macerator"                  },
      { item = "Ledox Dust",                                hops = 1, via = "macerator"                  },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Sodium Hydroxide Dust",                     hops = 3, via = "chemical_bath"              },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
    },
    processed = {
      { item = "Biotite Dust",                              hops = 3, via = "centrifuge"                 },
      { item = "Boron Dust",                                hops = 2, via = "electrolyzer"               },
      { item = "Hydrogen Cell",                             hops = 3, via = "electrolyzer"               },
      { item = "Marble Dust",                               hops = 3, via = "centrifuge"                 },
      { item = "Metal Mixture Dust",                        hops = 3, via = "centrifuge"                 },
      { item = "Oxygen Cell",                               hops = 3, via = "electrolyzer"               },
      { item = "Platinum Metallic Powder Dust",             hops = 2, via = "centrifuge"                 },
      ...
      { item = "Sodium Dust",                               hops = 2, via = "electrolyzer"               },
      { item = "Tungstate Dust",                            hops = 2, via = "centrifuge"                 },
      { item = "Water Cell",                                hops = 2, via = "electrolyzer"               },
    },
  },
  ["Everglades"] = {   -- evergladesAsteroid, drones 6..8, module tier 1
    ...
    main = {
      { item = "Alburnite Dust",                            hops = 3, via = "simple_washer"              },
      { item = "Calcium Dust",                              hops = 1, via = "macerator"                  },
      { item = "Cerium-Rich Mixture Dust",                  hops = 1, via = "macerator"                  },
      { item = "Chrome Dust",                               hops = 2, via = "thermal_centrifuge"         },
      { item = "Crocoite Dust",                             hops = 3, via = "simple_washer"              },
      { item = "Erbium Dust",                               hops = 2, via = "thermal_centrifuge"         },
      { item = "Gadolinite (Y) Dust",                       hops = 3, via = "simple_washer"              },
      { item = "Germanium Dust",                            hops = 2, via = "thermal_centrifuge"         },
      { item = "Gold Dust",                                 hops = 1, via = "macerator"                  },
      { item = "Honeaite Dust",                             hops = 3, via = "simple_washer"              },
      { item = "Impure Alburnite Dust",                     hops = 2, via = "macerator"                  },
      { item = "Impure Crocoite Dust",                      hops = 2, via = "macerator"                  },
      { item = "Impure Gadolinite (Y) Dust",                hops = 2, via = "macerator"                  },
      { item = "Impure Honeaite Dust",                      hops = 2, via = "macerator"                  },
      { item = "Impure Koboldite Dust",                     hops = 2, via = "macerator"                  },
      { item = "Impure Lautarite Dust",                     hops = 2, via = "macerator"                  },
      { item = "Impure Lepersonnite Dust",                  hops = 2, via = "macerator"                  },
      { item = "Impure Rare Earth (I) Dust",                hops = 2, via = "macerator"                  },
      { item = "Impure Rare Earth (II) Dust",               hops = 2, via = "macerator"                  },
      { item = "Impure Rare Earth (III) Dust",              hops = 2, via = "macerator"                  },
      { item = "Impure Zircon Dust",                        hops = 2, via = "macerator"                  },
      { item = "Iodine Dust",                               hops = 2, via = "thermal_centrifuge"         },
      { item = "Koboldite Dust",                            hops = 3, via = "simple_washer"              },
      { item = "Lautarite Dust",                            hops = 3, via = "simple_washer"              },
      { item = "Lead Dust",                                 hops = 1, via = "macerator"                  },
      { item = "Lepersonnite Dust",                         hops = 3, via = "simple_washer"              },
      { item = "Neodymium Dust",                            hops = 2, via = "thermal_centrifuge"         },
      { item = "Nether Quartz Dust",                        hops = 1, via = "macerator"                  },
      { item = "Nickel Dust",                               hops = 1, via = "macerator"                  },
      { item = "Rare Earth (I) Dust",                       hops = 3, via = "simple_washer"              },
      { item = "Rare Earth (II) Dust",                      hops = 3, via = "simple_washer"              },
      { item = "Rare Earth (III) Dust",                     hops = 3, via = "simple_washer"              },
      { item = "Raw Silicon Dust",                          hops = 2, via = "thermal_centrifuge"         },
      { item = "Runite Dust",                               hops = 1, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 1, via = "macerator"                  },
      { item = "Thallium Dust",                             hops = 2, via = "thermal_centrifuge"         },
      { item = "Thaumium Dust",                             hops = 2, via = "thermal_centrifuge"         },
      { item = "Ytterbium Dust",                            hops = 2, via = "thermal_centrifuge"         },
      { item = "Yttrium Dust",                              hops = 2, via = "thermal_centrifuge"         },
      { item = "Zircon Dust",                               hops = 3, via = "simple_washer"              },
      { item = "Zirconium Dust",                            hops = 1, via = "macerator"                  },
    },
    processed = {
      { item = "Alumina Dust",                              hops = 3, via = "electrolyzer"               },
      { item = "Aluminium Dust",                            hops = 3, via = "electrolyzer"               },
  ...
  ["Gem Ores"] = {   -- gemAsteroid, drones 0..5, module tier 1
    ...
    main = {
      { item = "Alumina Dust",                              hops = 1, via = "macerator"                  },
      { item = "Amethyst",                                  hops = 1, via = "macerator"                  },
      { item = "Amethyst Dust",                             hops = 2, via = "macerator"                  },
      { item = "Bauxite Dust",                              hops = 3, via = "simple_washer"              },
      { item = "Beryllium Dust",                            hops = 1, via = "macerator"                  },
      { item = "Blue Topaz",                                hops = 1, via = "macerator"                  },
      { item = "Blue Topaz Dust",                           hops = 2, via = "macerator"                  },
      { item = "Chipped Amethyst",                          hops = 3, via = "sifter"                     },
      { item = "Chipped Blue Topaz",                        hops = 3, via = "sifter"                     },
      { item = "Chipped Diamond",                           hops = 3, via = "sifter"                     },
      { item = "Chipped Emerald",                           hops = 3, via = "sifter"                     },
      { item = "Chipped Green Sapphire",                    hops = 3, via = "sifter"                     },
      { item = "Chipped Opal",                              hops = 3, via = "sifter"                     },
      { item = "Chipped Ruby",                              hops = 3, via = "sifter"                     },
      { item = "Chipped Sapphire",                          hops = 3, via = "sifter"                     },
      { item = "Chipped Topaz",                             hops = 3, via = "sifter"                     },
      { item = "Chrome Dust",                               hops = 1, via = "macerator"                  },
      { item = "Diamond",                                   hops = 3, via = "sifter"                     },
      { item = "Diamond Dust",                              hops = 3, via = "simple_washer"              },
      { item = "Emerald",                                   hops = 3, via = "sifter"                     },
      { item = "Emerald Dust",                              hops = 3, via = "simple_washer"              },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Exquisite Amethyst",                        hops = 3, via = "sifter"                     },
      { item = "Exquisite Blue Topaz",                      hops = 3, via = "sifter"                     },
      { item = "Exquisite Diamond",                         hops = 3, via = "sifter"                     },
      { item = "Exquisite Emerald",                         hops = 3, via = "sifter"                     },
      { item = "Exquisite Green Sapphire",                  hops = 3, via = "sifter"                     },
      { item = "Exquisite Opal",                            hops = 3, via = "sifter"                     },
      { item = "Exquisite Ruby",                            hops = 3, via = "sifter"                     },
      { item = "Exquisite Sapphire",                        hops = 3, via = "sifter"                     },
      { item = "Exquisite Topaz",                           hops = 3, via = "sifter"                     },
      { item = "Fiery Steel Dust",                          hops = 3, via = "chemical_bath"              },
      { item = "Flawed Amethyst",                           hops = 3, via = "sifter"                     },
      { item = "Flawed Blue Topaz",                         hops = 3, via = "sifter"                     },
      { item = "Flawed Diamond",                            hops = 3, via = "sifter"                     },
      { item = "Flawed Emerald",                            hops = 3, via = "sifter"                     },
      { item = "Flawed Green Sapphire",                     hops = 3, via = "sifter"                     },
      { item = "Flawed Opal",                               hops = 3, via = "sifter"                     },
      { item = "Flawed Ruby",                               hops = 3, via = "sifter"                     },
      { item = "Flawed Sapphire",                           hops = 3, via = "sifter"                     },
      { item = "Flawed Topaz",                              hops = 3, via = "sifter"                     },
      { item = "Flawless Amethyst",                         hops = 3, via = "sifter"                     },
      { item = "Flawless Blue Topaz",                       hops = 3, via = "sifter"                     },
      { item = "Flawless Diamond",                          hops = 3, via = "sifter"                     },
      { item = "Flawless Emerald",                          hops = 3, via = "sifter"                     },
      { item = "Flawless Green Sapphire",                   hops = 3, via = "sifter"                     },
      { item = "Flawless Opal",                             hops = 3, via = "sifter"                     },
      { item = "Flawless Ruby",                             hops = 3, via = "sifter"                     },
      { item = "Flawless Sapphire",                         hops = 3, via = "sifter"                     },
      { item = "Flawless Topaz",                            hops = 3, via = "sifter"                     },
      { item = "Gallium Dust",                              hops = 3, via = "macerator"                  },
      { item = "Graphite Dust",                             hops = 1, via = "macerator"                  },
      { item = "Green Sapphire",                            hops = 3, via = "sifter"                     },
      { item = "Green Sapphire Dust",                       hops = 2, via = "thermal_centrifuge"         },
      { item = "Grossular Dust",                            hops = 1, via = "macerator"                  },
      { item = "Nether Star",                               hops = 1, via = "macerator"                  },
      { item = "Nether Star Dust",                          hops = 2, via = "macerator"                  },
      { item = "Opal",                                      hops = 3, via = "sifter"                     },
      { item = "Opal Dust",                                 hops = 3, via = "simple_washer"              },
      { item = "Quantum Star",                              hops = 2, via = "chemical_bath"              },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Red Garnet Dust",                           hops = 2, via = "thermal_centrifuge"         },
      { item = "Ruby",                                      hops = 3, via = "sifter"                     },
      { item = "Ruby Dust",                                 hops = 3, via = "simple_washer"              },
      { item = "Rutile Dust",                               hops = 2, via = "thermal_centrifuge"         },
      { item = "Sapphire",                                  hops = 3, via = "sifter"                     },
      { item = "Sapphire Dust",                             hops = 2, via = "thermal_centrifuge"         },
      { item = "Small Pile of Rutile Dust",                 hops = 3, via = "electromagnetic_separator"  },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
      { item = "Tanzanite",                                 hops = 1, via = "macerator"                  },
      { item = "Tanzanite Dust",                            hops = 2, via = "macerator"                  },
      { item = "Topaz",                                     hops = 1, via = "macerator"                  },
      { item = "Topaz Dust",                                hops = 2, via = "macerator"                  },
      { item = "Vinteum",                                   hops = 1, via = "macerator"                  },
      { item = "Vinteum Dust",                              hops = 2, via = "macerator"                  },
      { item = "Zirconium Nugget",                          hops = 3, via = "electromagnetic_separator"  },
    },
    processed = {
      { item = "Almandine Dust",                            hops = 3, via = "centrifuge"                 },
      ...
      { item = "Calcite Dust",                              hops = 2, via = "centrifuge"                 },
      { item = "Calcium Dust",                              hops = 2, via = "electrolyzer"               },
      { item = "Carbon Dust",                               hops = 2, via = "electrolyzer"               },
      { item = "Gold Dust",                                 hops = 2, via = "centrifuge"                 },
      { item = "Hydrogen Cell",                             hops = 3, via = "electrolyzer"               },
      { item = "Iron Dust",                                 hops = 2, via = "centrifuge"                 },
      { item = "Marble Dust",                               hops = 3, via = "centrifuge"                 },
      ...
      { item = "Sodalite Dust",                             hops = 3, via = "centrifuge"                 },
      { item = "Spessartine Dust",                          hops = 3, via = "centrifuge"                 },
      { item = "Thaumium Dust",                             hops = 3, via = "centrifuge"                 },
      { item = "Tungstate Dust",                            hops = 2, via = "centrifuge"                 },
      { item = "Vanadium Dust",                             hops = 2, via = "centrifuge"                 },
    },
  },
  ["Holmium/Samarium"] = {   -- holmiumSamariumAsteroid, drones 7..12, module tier 2
    ...
    main = {
      { item = "Chipped Tiberium",                          hops = 3, via = "sifter"                     },
      { item = "Exquisite Tiberium",                        hops = 3, via = "sifter"                     },
      { item = "Flawed Tiberium",                           hops = 3, via = "sifter"                     },
      { item = "Flawless Tiberium",                         hops = 3, via = "sifter"                     },
      { item = "Holmium Dust",                              hops = 1, via = "macerator"                  },
      { item = "Samarium Ore Concentrate Dust",             hops = 1, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 1, via = "macerator"                  },
      { item = "Strontium Dust",                            hops = 1, via = "macerator"                  },
      { item = "Tiberium",                                  hops = 1, via = "macerator"                  },
      { item = "Tiberium Dust",                             hops = 2, via = "macerator"                  },
    },
    processed = {
      { item = "Alumina Dust",                              hops = 3, via = "electrolyzer"               },
      { item = "Aluminium Dust",                            hops = 3, via = "electrolyzer"               },
  ...
  ["Ichorium"] = {   -- ichoriumAsteroid, drones 9..12, module tier 3
    ...
    main = {
      { item = "Americium Dust",                            hops = 1, via = "macerator"                  },
      { item = "Desh Dust",                                 hops = 1, via = "macerator"                  },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Fiery Steel Dust",                          hops = 2, via = "chemical_bath"              },
      { item = "Ichorium Dust",                             hops = 1, via = "macerator"                  },
      { item = "Iridium Metal Residue Dust",                hops = 3, via = "macerator"                  },
      { item = "Iron Dust",                                 hops = 1, via = "macerator"                  },
      { item = "Meteoric Iron Dust",                        hops = 3, via = "simple_washer"              },
      { item = "Nickel Dust",                               hops = 2, via = "thermal_centrifuge"         },
      { item = "Platinum Metallic Powder Dust",             hops = 2, via = "chemical_bath"              },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Shadow Iron Dust",                          hops = 3, via = "simple_washer"              },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
    },
    processed = {
      { item = "Biotite Dust",                              hops = 3, via = "centrifuge"                 },
  ...
  ["Indium"] = {   -- indiumAsteroid, drones 4..9, module tier 2
    ...
    main = {
      { item = "Cadmium Dust",                              hops = 1, via = "macerator"                  },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Gallium Dust",                              hops = 2, via = "thermal_centrifuge"         },
      { item = "Indium Dust",                               hops = 1, via = "macerator"                  },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Sphalerite Dust",                           hops = 3, via = "simple_washer"              },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
      { item = "Tin Dust",                                  hops = 1, via = "macerator"                  },
      { item = "Yellow Garnet",                             hops = 1, via = "macerator"                  },
      { item = "Yellow Garnet Dust",                        hops = 2, via = "macerator"                  },
      { item = "Zinc Dust",                                 hops = 2, via = "chemical_bath"              },
    },
    processed = {
      { item = "Andradite Dust",                            hops = 3, via = "centrifuge"                 },
      { item = "Biotite Dust",                              hops = 3, via = "centrifuge"                 },
      { item = "Grossular Dust",                            hops = 3, via = "centrifuge"                 },
      { item = "Marble Dust",                               hops = 3, via = "centrifuge"                 },
      { item = "Metal Mixture Dust",                        hops = 3, via = "centrifuge"                 },
      { item = "Platinum Metallic Powder Dust",             hops = 2, via = "centrifuge"                 },
      { item = "Potassium Feldspar Dust",                   hops = 3, via = "centrifuge"                 },
      ...
      { item = "Sodalite Dust",                             hops = 3, via = "centrifuge"                 },
      { item = "Tungstate Dust",                            hops = 2, via = "centrifuge"                 },
      { item = "Uvarovite Dust",                            hops = 3, via = "centrifuge"                 },
    },
  },
  ["Infinity Catalyst"] = {   -- infinityCatalystAsteroid, drones 7..12, module tier 2
    ...
    main = {
      { item = "Cosmic Neutronium Dust",                    hops = 1, via = "macerator"                  },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Infinity Catalyst Dust",                    hops = 1, via = "macerator"                  },
      { item = "Neutronium Dust",                           hops = 1, via = "macerator"                  },
      { item = "Neutronium Nanoparticles",                  hops = 2, via = "macerator"                  },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
  ...
  ["Iron"] = {   -- ironAsteroid, drones 0..6, module tier 1
    ...
    main = {
      { item = "Basalt Dust",                               hops = 1, via = "macerator"                  },
      { item = "Basaltic Mineral Sand",                     hops = 3, via = "simple_washer"              },
      { item = "Black Granite Dust",                        hops = 1, via = "macerator"                  },
      { item = "Copper Dust",                               hops = 1, via = "macerator"                  },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Fiery Steel Dust",                          hops = 2, via = "chemical_bath"              },
      { item = "Gold Dust",                                 hops = 2, via = "chemical_bath"              },
      { item = "Granitic Mineral Sand",                     hops = 3, via = "simple_washer"              },
      { item = "Ground Basaltic Mineral Sand",              hops = 1, via = "macerator"                  },
      { item = "Ground Granitic Mineral Sand",              hops = 1, via = "macerator"                  },
      { item = "Iron Dust",                                 hops = 1, via = "macerator"                  },
      { item = "Magnetite Dust",                            hops = 2, via = "thermal_centrifuge"         },
      { item = "Nickel Dust",                               hops = 1, via = "macerator"                  },
      { item = "Pyrite Dust",                               hops = 3, via = "simple_washer"              },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Small Pile of Zircon Dust",                 hops = 3, via = "electromagnetic_separator"  },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
      { item = "Sulfur Dust",                               hops = 1, via = "macerator"                  },
      { item = "Tin Dust",                                  hops = 2, via = "thermal_centrifuge"         },
      { item = "Tiny Pile of Zircon Dust",                  hops = 3, via = "electromagnetic_separator"  },
      { item = "Tricalcium Phosphate Dust",                 hops = 2, via = "thermal_centrifuge"         },
    },
    processed = {
      { item = "Alumina Dust",                              hops = 3, via = "electrolyzer"               },
      { item = "Ashes",                                     hops = 3, via = "centrifuge"                 },
      { item = "Biotite Dust",                              hops = 2, via = "centrifuge"                 },
      { item = "Calcite Dust",                              hops = 2, via = "centrifuge"                 },
      { item = "Calcium Dust",                              hops = 3, via = "centrifuge"                 },
      { item = "Carbon Dust",                               hops = 3, via = "electrolyzer"               },
      { item = "Dark Ashes",                                hops = 2, via = "centrifuge"                 },
      { item = "Flint Dust",                                hops = 2, via = "centrifuge"                 },
      { item = "Magnesium Dust",                            hops = 3, via = "electrolyzer"               },
      { item = "Marble Dust",                               hops = 3, via = "centrifuge"                 },
      { item = "Metal Mixture Dust",                        hops = 3, via = "centrifuge"                 },
      { item = "Olivine Dust",                              hops = 2, via = "centrifuge"                 },
      { item = "Oxygen Cell",                               hops = 3, via = "electrolyzer"               },
      { item = "Phosphate Dust",                            hops = 3, via = "centrifuge"                 },
      { item = "Platinum Metallic Powder Dust",             hops = 2, via = "centrifuge"                 },
      { item = "Potassium Dust",                            hops = 3, via = "electrolyzer"               },
      { item = "Potassium Feldspar Dust",                   hops = 3, via = "centrifuge"                 },
      { item = "Quartzite Dust",                            hops = 3, via = "centrifuge"                 },
      { item = "Raw Silicon Dust",                          hops = 3, via = "electrolyzer"               },
      { item = "Sand",                                      hops = 2, via = "centrifuge"                 },
      { item = "Silicon Dioxide Dust",                      hops = 2, via = "centrifuge"                 },
      { item = "Sodalite Dust",                             hops = 3, via = "centrifuge"                 },
      { item = "Tungstate Dust",                            hops = 2, via = "centrifuge"                 },
    },
  },
  ["Lanthanum"] = {   -- lanthanumAsteroid, drones 4..10, module tier 2
    ...
    main = {
      { item = "Chipped Orundum",                           hops = 3, via = "sifter"                     },
      { item = "Exquisite Orundum",                         hops = 3, via = "sifter"                     },
      { item = "Flawed Orundum",                            hops = 3, via = "sifter"                     },
      { item = "Flawless Orundum",                          hops = 3, via = "sifter"                     },
      { item = "Lanthanum Dust",                            hops = 1, via = "macerator"                  },
      { item = "Lead Dust",                                 hops = 1, via = "macerator"                  },
      { item = "Orundum",                                   hops = 1, via = "macerator"                  },
      { item = "Orundum Dust",                              hops = 2, via = "macerator"                  },
      { item = "Silver Dust",                               hops = 2, via = "chemical_bath"              },
      { item = "Stone Dust",                                hops = 1, via = "macerator"                  },
      { item = "Sulfur Dust",                               hops = 2, via = "thermal_centrifuge"         },
      { item = "Trinium Dust",                              hops = 1, via = "macerator"                  },
    },
    processed = {
      { item = "Alumina Dust",                              hops = 3, via = "electrolyzer"               },
      { item = "Aluminium Dust",                            hops = 3, via = "electrolyzer"               },
  ...
  ["Lead"] = {   -- leadAsteroid, drones 0..7, module tier 1
    ...
    main = {
      { item = "Arsenic Dust",                              hops = 1, via = "macerator"                  },
      { item = "Barium Dust",                               hops = 1, via = "macerator"                  },
      { item = "Caesium Dust",                              hops = 2, via = "thermal_centrifuge"         },
      { item = "Cryolite Dust",                             hops = 3, via = "chemical_bath"              },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Lead Dust",                                 hops = 3, via = "simple_washer"              },
      { item = "Lepidolite Dust",                           hops = 3, via = "simple_washer"              },
      { item = "Lithium Chloride Dust",                     hops = 3, via = "chemical_bath"              },
      { item = "Lithium Dust",                              hops = 1, via = "macerator"                  },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Rock Salt",                                 hops = 3, via = "chemical_bath"              },
      { item = "Silver Dust",                               hops = 1, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
      { item = "Sulfur Dust",                               hops = 2, via = "thermal_centrifuge"         },
    },
    processed = {
  ...
  ["Lutetium"] = {   -- lutetiumAsteroid, drones 4..8, module tier 1
    ...
    main = {
      { item = "Cinnabar Dust",                             hops = 1, via = "macerator"                  },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Glowstone Dust",                            hops = 3, via = "macerator"                  },
      { item = "Lutetium Dust",                             hops = 1, via = "macerator"                  },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Rare Earth",                                hops = 2, via = "thermal_centrifuge"         },
      { item = "Redstone",                                  hops = 3, via = "simple_washer"              },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
      { item = "Tantalum Dust",                             hops = 1, via = "macerator"                  },
      { item = "Tellurium Dust",                            hops = 1, via = "macerator"                  },
      { item = "Thulium Dust",                              hops = 1, via = "macerator"                  },
    },
    processed = {
      { item = "Biotite Dust",                              hops = 3, via = "centrifuge"                 },
      { item = "Marble Dust",                               hops = 3, via = "centrifuge"                 },
      ...
      { item = "Silicon Dioxide Dust",                      hops = 3, via = "electrolyzer"               },
      { item = "Sodalite Dust",                             hops = 3, via = "centrifuge"                 },
      { item = "Sulfur Dust",                               hops = 2, via = "centrifuge"                 },
      { item = "Tungstate Dust",                            hops = 2, via = "centrifuge"                 },
    },
  },
  ["Magnesium"] = {   -- magnesiumAsteroid, drones 3..8, module tier 1
    ...
    main = {
      { item = "Chipped Fluorspar",                         hops = 3, via = "sifter"                     },
      { item = "Chrome Dust",                               hops = 1, via = "macerator"                  },
      { item = "Exquisite Fluorspar",                       hops = 3, via = "sifter"                     },
      { item = "Fiery Steel Dust",                          hops = 3, via = "chemical_bath"              },
      { item = "Flawed Fluorspar",                          hops = 3, via = "sifter"                     },
      { item = "Flawless Fluorspar",                        hops = 3, via = "sifter"                     },
      { item = "Fluorspar",                                 hops = 1, via = "macerator"                  },
      { item = "Fluorspar Dust",                            hops = 2, via = "macerator"                  },
      { item = "Iron Dust",                                 hops = 2, via = "thermal_centrifuge"         },
      { item = "Magnesium Dust",                            hops = 3, via = "simple_washer"              },
      { item = "Manganese Dust",                            hops = 3, via = "simple_washer"              },
      { item = "Olivine",                                   hops = 1, via = "macerator"                  },
      { item = "Olivine Dust",                              hops = 2, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 1, via = "macerator"                  },
    },
    processed = {
      { item = "Alumina Dust",                              hops = 3, via = "electrolyzer"               },
      ...
      { item = "Biotite Dust",                              hops = 2, via = "centrifuge"                 },
      { item = "Calcite Dust",                              hops = 3, via = "centrifuge"                 },
      { item = "Calcium Dust",                              hops = 3, via = "electrolyzer"               },
      { item = "Chromite Dust",                             hops = 3, via = "centrifuge"                 },
      { item = "Ilmenite Dust",                             hops = 3, via = "centrifuge"                 },
      { item = "Marble Dust",                               hops = 2, via = "centrifuge"                 },
      { item = "Metal Mixture Dust",                        hops = 2, via = "centrifuge"                 },
  ...
  ["Mysterious Crystal"] = {   -- mysteriousCrystalAsteroid, drones 4..12, module tier 1
    ...
    main = {
      { item = "End Powder",                                hops = 1, via = "macerator"                  },
      { item = "Endium Dust",                               hops = 1, via = "macerator"                  },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Mysterious Crystal Dust",                   hops = 1, via = "macerator"                  },
      { item = "Mytryl Dust",                               hops = 3, via = "simple_washer"              },
      { item = "Oriharukon Dust",                           hops = 1, via = "macerator"                  },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Samarium Ore Concentrate Dust",             hops = 1, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
      { item = "Zinc Dust",                                 hops = 2, via = "thermal_centrifuge"         },
    },
    processed = {
      { item = "Biotite Dust",                              hops = 3, via = "centrifuge"                 },
      { item = "Marble Dust",                               hops = 3, via = "centrifuge"                 },
      ...
      { item = "Sand",                                      hops = 2, via = "centrifuge"                 },
      { item = "Silicon Dioxide Dust",                      hops = 3, via = "electrolyzer"               },
      { item = "Small Pile of Endium Dust",                 hops = 2, via = "centrifuge"                 },
      { item = "Sodalite Dust",                             hops = 3, via = "centrifuge"                 },
      { item = "Tiny Pile of Endereye Dust",                hops = 2, via = "centrifuge"                 },
      { item = "Tungstate Dust",                            hops = 2, via = "centrifuge"                 },
    },
  },
  ["Naquadah"] = {   -- naquadahAsteroid, drones 4..7, module tier 1
    ...
    main = {
      { item = "Enriched-Naquadah Oxide Mixture Dust",      hops = 1, via = "macerator"                  },
      { item = "Naquadah Oxide Mixture Dust",               hops = 1, via = "macerator"                  },
      { item = "Naquadria Oxide Mixture Dust",              hops = 1, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 1, via = "macerator"                  },
    },
    processed = {
      { item = "Alumina Dust",                              hops = 3, via = "electrolyzer"               },
      ...
      { item = "Chromite Dust",                             hops = 3, via = "centrifuge"                 },
      { item = "Ilmenite Dust",                             hops = 3, via = "centrifuge"                 },
      { item = "Indium Phosphate Dust",                     hops = 2, via = "centrifuge"                 },
      { item = "Low Quality Naquadria Phosphate Dust",      hops = 2, via = "centrifuge"                 },
      { item = "Magnesium Dust",                            hops = 3, via = "centrifuge"                 },
      { item = "Marble Dust",                               hops = 2, via = "centrifuge"                 },
      { item = "Metal Mixture Dust",                        hops = 2, via = "centrifuge"                 },
      { item = "Oxygen Cell",                               hops = 3, via = "electrolyzer"               },
  ...
  ["Nether Ores"] = {   -- NetherOreAsteroid, drones 3..6, module tier 1
    ...
    main = {
      { item = "Barite Dust",                               hops = 2, via = "thermal_centrifuge"         },
      { item = "Barium Dust",                               hops = 2, via = "chemical_bath"              },
      { item = "Certus Quartz",                             hops = 1, via = "macerator"                  },
      { item = "Certus Quartz Dust",                        hops = 2, via = "macerator"                  },
      { item = "Firestone Dust",                            hops = 2, via = "macerator"                  },
      { item = "Hydrated Coal Dust",                        hops = 3, via = "chemical_bath"              },
      { item = "Nether Quartz",                             hops = 3, via = "sifter"                     },
      { item = "Nether Quartz Dust",                        hops = 3, via = "simple_washer"              },
      { item = "Netherrack Dust",                           hops = 1, via = "macerator"                  },
      { item = "Quartzite",                                 hops = 1, via = "macerator"                  },
      { item = "Quartzite Dust",                            hops = 2, via = "macerator"                  },
      { item = "Raw Firestone",                             hops = 1, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
      { item = "Sulfur Dust",                               hops = 1, via = "macerator"                  },
      { item = "Tiberium",                                  hops = 2, via = "chemical_bath"              },
      { item = "Tiberium Dust",                             hops = 3, via = "macerator"                  },
    },
    processed = {
      { item = "Biotite Dust",                              hops = 3, via = "centrifuge"                 },
      { item = "Carbon Dust",                               hops = 3, via = "electrolyzer"               },
      { item = "Coal Dust",                                 hops = 2, via = "centrifuge"                 },
      { item = "Gold Dust",                                 hops = 2, via = "centrifuge"                 },
      { item = "Marble Dust",                               hops = 3, via = "centrifuge"                 },
      { item = "Metal Mixture Dust",                        hops = 3, via = "centrifuge"                 },
      { item = "Potassium Feldspar Dust",                   hops = 3, via = "centrifuge"                 },
      { item = "Pyrite Dust",                               hops = 3, via = "centrifuge"                 },
      { item = "Raw Silicon Dust",                          hops = 3, via = "centrifuge"                 },
      { item = "Redstone",                                  hops = 2, via = "centrifuge"                 },
      { item = "Ruby Dust",                                 hops = 3, via = "centrifuge"                 },
      { item = "Sodalite Dust",                             hops = 3, via = "centrifuge"                 },
    },
  },
  ["Nickel"] = {   -- nickelAsteroid, drones 0..4, module tier 1
    ...
    main = {
      ...
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Fiery Steel Dust",                          hops = 2, via = "chemical_bath"              },
      { item = "Garnierite Dust",                           hops = 3, via = "simple_washer"              },
      { item = "Iron Dust",                                 hops = 1, via = "macerator"                  },
      { item = "Nickel Dust",                               hops = 1, via = "macerator"                  },
      { item = "Pentlandite Dust",                          hops = 3, via = "simple_washer"              },
      { item = "Platinum Metallic Powder Dust",             hops = 2, via = "thermal_centrifuge"         },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
      { item = "Sulfur Dust",                               hops = 2, via = "thermal_centrifuge"         },
    },
  ...
  ["Niobium"] = {   -- niobiumAsteroid, drones 4..8, module tier 1
    ...
    main = {
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Niobium Dust",                              hops = 1, via = "macerator"                  },
      { item = "Quantium Dust",                             hops = 1, via = "macerator"                  },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
      { item = "Ytterbium Dust",                            hops = 1, via = "macerator"                  },
      { item = "Yttrium Dust",                              hops = 1, via = "macerator"                  },
    },
    processed = {
      { item = "Biotite Dust",                              hops = 3, via = "centrifuge"                 },
      { item = "Marble Dust",                               hops = 3, via = "centrifuge"                 },
  ...
  ["Phosphate"] = {   -- phosphateAsteroid, drones 4..10, module tier 1
    ...
    main = {
      { item = "Apatite",                                   hops = 1, via = "macerator"                  },
      { item = "Apatite Dust",                              hops = 2, via = "macerator"                  },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Phosphate Dust",                            hops = 2, via = "thermal_centrifuge"         },
      { item = "Phosphorus Dust",                           hops = 1, via = "macerator"                  },
      { item = "Pyrochlore Dust",                           hops = 3, via = "macerator"                  },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
      { item = "Sulfur Dust",                               hops = 1, via = "macerator"                  },
      { item = "Tricalcium Phosphate",                      hops = 1, via = "macerator"                  },
      { item = "Tricalcium Phosphate Dust",                 hops = 2, via = "macerator"                  },
    },
    processed = {
      { item = "Biotite Dust",                              hops = 3, via = "centrifuge"                 },
      { item = "Calcium Dust",                              hops = 3, via = "electrolyzer"               },
  ...
  ["PlatLine Dust"] = {   -- platlinePureAsteroid, drones 6..9, module tier 3
    ...
    main = {
      { item = "Iridium Dust",                              hops = 0, via = "dropped directly"           },
      { item = "Osmium Dust",                               hops = 0, via = "dropped directly"           },
      { item = "Palladium Dust",                            hops = 0, via = "dropped directly"           },
      { item = "Platinum Dust",                             hops = 0, via = "dropped directly"           },
      { item = "Rhodium Dust",                              hops = 0, via = "dropped directly"           },
      { item = "Ruthenium Dust",                            hops = 0, via = "dropped directly"           },
    },
    processed = {
    },
  },
  ["PlatLine Ore"] = {   -- platlineOreAsteroid, drones 2..6, module tier 1
    ...
    main = {
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Iridium Metal Residue Dust",                hops = 1, via = "macerator"                  },
      { item = "Nickel Dust",                               hops = 1, via = "macerator"                  },
      { item = "Palladium Metallic Powder Dust",            hops = 1, via = "macerator"                  },
      { item = "Platinum Metallic Powder Dust",             hops = 1, via = "macerator"                  },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Rarest Metal Residue Dust",                 hops = 2, via = "thermal_centrifuge"         },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
    },
    processed = {
      { item = "Biotite Dust",                              hops = 3, via = "centrifuge"                 },
  ...
  ["Quartz"] = {   -- quartzAsteroid, drones 1..6, module tier 1
    ...
    main = {
      ...
      { item = "Quartzite Dust",                            hops = 2, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
      { item = "Vanadium Dust",                             hops = 1, via = "macerator"                  },
    },
    processed = {
      { item = "Biotite Dust",                              hops = 3, via = "centrifuge"                 },
      { item = "Carbon Dust",                               hops = 3, via = "electrolyzer"               },
  ...
  ["Salt"] = {   -- saltAsteroid, drones 0..4, module tier 1
    ...
    main = {
      { item = "Borax Dust",                                hops = 2, via = "thermal_centrifuge"         },
      { item = "Chipped Rock Salt",                         hops = 3, via = "sifter"                     },
      { item = "Chipped Salt",                              hops = 3, via = "sifter"                     },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Exquisite Rock Salt",                       hops = 3, via = "sifter"                     },
      { item = "Exquisite Salt",                            hops = 3, via = "sifter"                     },
      { item = "Flawed Rock Salt",                          hops = 3, via = "sifter"                     },
      { item = "Flawed Salt",                               hops = 3, via = "sifter"                     },
      { item = "Flawless Rock Salt",                        hops = 3, via = "sifter"                     },
      { item = "Flawless Salt",                             hops = 3, via = "sifter"                     },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Rock Salt",                                 hops = 1, via = "macerator"                  },
      { item = "Salt",                                      hops = 1, via = "macerator"                  },
      { item = "Saltpeter Dust",                            hops = 1, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
    },
    processed = {
      { item = "Biotite Dust",                              hops = 3, via = "centrifuge"                 },
      { item = "Boron Dust",                                hops = 3, via = "electrolyzer"               },
      { item = "Marble Dust",                               hops = 3, via = "centrifuge"                 },
      { item = "Metal Mixture Dust",                        hops = 3, via = "centrifuge"                 },
      { item = "Oxygen Cell",                               hops = 2, via = "electrolyzer"               },
      { item = "Platinum Metallic Powder Dust",             hops = 2, via = "centrifuge"                 },
      { item = "Potassium Dust",                            hops = 2, via = "electrolyzer"               },
      { item = "Potassium Feldspar Dust",                   hops = 3, via = "centrifuge"                 },
      { item = "Quartzite Dust",                            hops = 3, via = "centrifuge"                 },
      { item = "Sand",                                      hops = 2, via = "centrifuge"                 },
      { item = "Silicon Dioxide Dust",                      hops = 3, via = "electrolyzer"               },
      ...
      { item = "Sodium Dust",                               hops = 3, via = "electrolyzer"               },
      { item = "Tungstate Dust",                            hops = 2, via = "centrifuge"                 },
      { item = "Water Cell",                                hops = 3, via = "electrolyzer"               },
    },
  },
  ["Silicon"] = {   -- siliconAsteroid, drones 2..5, module tier 2
    ...
    main = {
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Mica Dust",                                 hops = 1, via = "macerator"                  },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Raw Silicon Dust",                          hops = 1, via = "macerator"                  },
      { item = "Silicon Solar Grade (Poly SI) Dust",        hops = 1, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
    },
    processed = {
      { item = "Alumina Dust",                              hops = 2, via = "electrolyzer"               },
  ...
  ["Space Ores"] = {   -- spaceOreAsteroid, drones 5..7, module tier 1
    ...
    main = {
      { item = "Alduorite Dust",                            hops = 1, via = "macerator"                  },
      { item = "Black Plutonium Dust",                      hops = 1, via = "macerator"                  },
      { item = "Callisto Ice Dust",                         hops = 1, via = "macerator"                  },
      { item = "Ceruclase Dust",                            hops = 1, via = "macerator"                  },
      { item = "Deep Iron Dust",                            hops = 3, via = "simple_washer"              },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Fiery Steel Dust",                          hops = 2, via = "chemical_bath"              },
      { item = "Iridium Metal Residue Dust",                hops = 3, via = "macerator"                  },
      { item = "Iron Dust",                                 hops = 1, via = "macerator"                  },
      ...
      { item = "Mytryl Dust",                               hops = 3, via = "simple_washer"              },
      { item = "Nickel Dust",                               hops = 2, via = "thermal_centrifuge"         },
      { item = "Orichalcum Dust",                           hops = 1, via = "macerator"                  },
      { item = "Platinum Metallic Powder Dust",             hops = 2, via = "chemical_bath"              },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Rubracium Dust",                            hops = 3, via = "simple_washer"              },
      { item = "Samarium Ore Concentrate Dust",             hops = 1, via = "macerator"                  },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
      { item = "Trinium Dust",                              hops = 1, via = "macerator"                  },
      { item = "Vulcanite Dust",                            hops = 1, via = "macerator"                  },
      { item = "Vyroxeres Dust",                            hops = 1, via = "macerator"                  },
      { item = "Zinc Dust",                                 hops = 2, via = "thermal_centrifuge"         },
    },
    processed = {
      { item = "Biotite Dust",                              hops = 3, via = "centrifuge"                 },
  ...
  ["Tengam"] = {   -- tengamAsteroid, drones 9..12, module tier 3
    ...
    main = {
      { item = "Chipped Orundum",                           hops = 3, via = "sifter"                     },
      { item = "Dilithium",                                 hops = 1, via = "macerator"                  },
      { item = "Dilithium Dust",                            hops = 2, via = "macerator"                  },
      { item = "Exquisite Orundum",                         hops = 3, via = "sifter"                     },
      { item = "Flawed Orundum",                            hops = 3, via = "sifter"                     },
      { item = "Flawless Orundum",                          hops = 3, via = "sifter"                     },
      { item = "Magnetic Neodymium Dust",                   hops = 1, via = "macerator"                  },
      { item = "Magnetic Samarium Dust",                    hops = 2, via = "thermal_centrifuge"         },
      { item = "Orundum",                                   hops = 1, via = "macerator"                  },
      { item = "Orundum Dust",                              hops = 2, via = "macerator"                  },
      { item = "Raw Tengam Dust",                           hops = 3, via = "simple_washer"              },
      { item = "Stone Dust",                                hops = 1, via = "macerator"                  },
      { item = "Vanadium Dust",                             hops = 1, via = "macerator"                  },
      { item = "Ytterbium Dust",                            hops = 1, via = "macerator"                  },
    },
    processed = {
      ...
      { item = "Marble Dust",                               hops = 2, via = "centrifuge"                 },
      { item = "Metal Mixture Dust",                        hops = 2, via = "centrifuge"                 },
      { item = "Neodymium Dust",                            hops = 2, via = "electrolyzer"               },
      { item = "Oxygen Cell",                               hops = 3, via = "electrolyzer"               },
      { item = "Potassium Dust",                            hops = 3, via = "electrolyzer"               },
      { item = "Potassium Feldspar Dust",                   hops = 2, via = "centrifuge"                 },
      { item = "Pyrolusite Dust",                           hops = 3, via = "centrifuge"                 },
      { item = "Quartzite Dust",                            hops = 2, via = "centrifuge"                 },
      { item = "Raw Silicon Dust",                          hops = 3, via = "electrolyzer"               },
      { item = "Samarium Dust",                             hops = 3, via = "electrolyzer"               },
      { item = "Silicon Dioxide Dust",                      hops = 3, via = "electrolyzer"               },
      { item = "Sodalite Dust",                             hops = 2, via = "centrifuge"                 },
      { item = "Sodium Dust",                               hops = 3, via = "electrolyzer"               },
    },
  ...
  ["Thaumium Dusts"] = {   -- thaumiumAsteroid, drones 2..5, module tier 1
    ...
    main = {
      { item = "Thaumium Dust",                             hops = 0, via = "dropped directly"           },
      { item = "Void Metal Dust",                           hops = 0, via = "dropped directly"           },
    },
    processed = {
    },
  },
  ["Tin"] = {   -- tinAsteroid, drones 0..4, module tier 1
    ...
    main = {
      { item = "Asbestos Dust",                             hops = 1, via = "macerator"                  },
      { item = "Cassiterite Dust",                          hops = 3, via = "simple_washer"              },
      { item = "Cassiterite Sand",                          hops = 3, via = "simple_washer"              },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Fiery Steel Dust",                          hops = 2, via = "chemical_bath"              },
      { item = "Ground Cassiterite Sand",                   hops = 1, via = "macerator"                  },
      { item = "Iron Dust",                                 hops = 1, via = "macerator"                  },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Silicon Dioxide Dust",                      hops = 2, via = "thermal_centrifuge"         },
      { item = "Small Pile of Zircon Dust",                 hops = 3, via = "electromagnetic_separator"  },
      ...
      { item = "Tiny Pile of Zircon Dust",                  hops = 3, via = "electromagnetic_separator"  },
      { item = "Zinc Dust",                                 hops = 2, via = "thermal_centrifuge"         },
      { item = "Zirconium Dust",                            hops = 3, via = "sifter"                     },
    },
    processed = {
      { item = "Biotite Dust",                              hops = 3, via = "centrifuge"                 },
      { item = "Magnesium Dust",                            hops = 2, via = "electrolyzer"               },
      { item = "Marble Dust",                               hops = 3, via = "centrifuge"                 },
      { item = "Metal Mixture Dust",                        hops = 3, via = "centrifuge"                 },
      { item = "Oxygen Cell",                               hops = 2, via = "electrolyzer"               },
      { item = "Platinum Metallic Powder Dust",             hops = 2, via = "centrifuge"                 },
  ...
  ["Tungsten-Titanium"] = {   -- tungstenTitaniumAsteroid, drones 0..5, module tier 1
    ...
    main = {
      { item = "Almandine Dust",                            hops = 1, via = "macerator"                  },
      { item = "Endstone Dust",                             hops = 1, via = "macerator"                  },
      { item = "Fiery Steel Dust",                          hops = 3, via = "chemical_bath"              },
      { item = "Lithium Dust",                              hops = 3, via = "macerator"                  },
      { item = "Manganese Dust",                            hops = 1, via = "macerator"                  },
      { item = "Molybdenum Dust",                           hops = 1, via = "macerator"                  },
      { item = "Monazite",                                  hops = 1, via = "macerator"                  },
      { item = "Monazite Dust",                             hops = 2, via = "macerator"                  },
      { item = "Neodymium Dust",                            hops = 3, via = "simple_washer"              },
      { item = "Quartz Sand",                               hops = 3, via = "macerator"                  },
      { item = "Rare Earth",                                hops = 2, via = "thermal_centrifuge"         },
      { item = "Silver Dust",                               hops = 2, via = "thermal_centrifuge"         },
      { item = "Stone Dust",                                hops = 2, via = "ore_washer"                 },
      { item = "Titanium Dust",                             hops = 3, via = "simple_washer"              },
      { item = "Tungsten Dust",                             hops = 3, via = "simple_washer"              },
    },
    processed = {
      { item = "Alumina Dust",                              hops = 2, via = "centrifuge"                 },
      { item = "Aluminium Dust",                            hops = 3, via = "electrolyzer"               },
      ...
      { item = "Calcium Dust",                              hops = 3, via = "electrolyzer"               },
      { item = "Carbon Dust",                               hops = 3, via = "electrolyzer"               },
      { item = "Chrome Dust",                               hops = 2, via = "centrifuge"                 },
      { item = "Gold Dust",                                 hops = 2, via = "centrifuge"                 },
      { item = "Iron Dust",                                 hops = 2, via = "centrifuge"                 },
      { item = "Marble Dust",                               hops = 3, via = "centrifuge"                 },
      { item = "Metal Mixture Dust",                        hops = 3, via = "centrifuge"                 },
      { item = "Phosphate Dust",                            hops = 3, via = "electrolyzer"               },
      { item = "Platinum Metallic Powder Dust",             hops = 2, via = "centrifuge"                 },
      { item = "Potassium Feldspar Dust",                   hops = 3, via = "centrifuge"                 },
      { item = "Quartzite Dust",                            hops = 3, via = "centrifuge"                 },
      { item = "Sand",                                      hops = 2, via = "centrifuge"                 },
  ...
  ["Uranium-Plutonium"] = {   -- uraniumPlutoniumAsteroid, drones 2..6, module tier 1
    ...
    main = {
      { item = "Lead Dust",                                 hops = 1, via = "macerator"                  },
      { item = "Plutonium 241 Dust",                        hops = 1, via = "macerator"                  },
      { item = "Radium 226 Dust",                           hops = 3, via = "sifter"                     },
      { item = "Stone Dust",                                hops = 1, via = "macerator"                  },
      { item = "Thorianite Dust",                           hops = 3, via = "simple_washer"              },
      { item = "Thorium Dust",                              hops = 1, via = "macerator"                  },
      { item = "Uranium 235 Dust",                          hops = 1, via = "macerator"                  },
      { item = "Uranium 238 Dust",                          hops = 1, via = "macerator"                  },
    },
    processed = {
      { item = "Alumina Dust",                              hops = 3, via = "electrolyzer"               },
      { item = "Aluminium Dust",                            hops = 3, via = "electrolyzer"               },
      ...
      { item = "Metal Mixture Dust",                        hops = 2, via = "centrifuge"                 },
      { item = "Oxygen Cell",                               hops = 3, via = "electrolyzer"               },
      { item = "Plutonium 239 Dust",                        hops = 2, via = "centrifuge"                 },
      { item = "Potassium Dust",                            hops = 3, via = "electrolyzer"               },
      { item = "Potassium Feldspar Dust",                   hops = 2, via = "centrifuge"                 },
      { item = "Pyrolusite Dust",                           hops = 3, via = "centrifuge"                 },
      { item = "Quartzite Dust",                            hops = 2, via = "centrifuge"                 },
      ...
      { item = "Sodium Dust",                               hops = 3, via = "electrolyzer"               },
      { item = "Thorium 232 Dust",                          hops = 2, via = "centrifuge"                 },
      { item = "Tiny Pile of Plutonium 241 Dust",           hops = 3, via = "centrifuge"                 },
      { item = "Tiny Pile of Uranium 238 Dust",             hops = 3, via = "centrifuge"                 },
    },
  },
}
