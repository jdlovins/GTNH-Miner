...
local ROLES = {
  ["broker"] = {
    ...
    files = { "broker-mk3.lua", "scheduler.lua", "loader.lua", "logger.lua",
              "list_components.lua", "detect_module.lua", "detect_sides.lua", "find_item.lua", "edit_conditions.lua" },
  ...
  ["jobnode"] = {
    ...
    files = { "job_node.lua", "list_components.lua", "detect_module.lua", "detect_sides.lua", "find_item.lua", "edit_conditions.lua" },
    config = { ["job_node_config.example.lua"] = "job_node_config.lua" },
